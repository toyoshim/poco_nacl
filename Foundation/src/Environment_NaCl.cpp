//
// Environment_NaCl.cpp
//
// $Id: //poco/1.4/Foundation/src/Environment_Nacl.cpp#2 $
//
// Library: Foundation
// Package: Core
// Module:  Environment
...
#include "Poco/Environment_NaCl.h"
...
{
	return "Pepper-19 or later";
}


std::string EnvironmentImpl::osArchitectureImpl()
{
#if POCO_TARGET_OSARCH == i386
	return "i686-nacl";
#else
	return "x86_64-nacl";
#endif
